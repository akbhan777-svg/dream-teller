...
export default function ContactClient() {
  ...
  const faqList: FAQItem[] = [
    ...
    },
    {
      ...
      answer: "일시적인 클라우드 서버나 API 제공 업체의 일시적 네트워크 지연일 수 있습니다. 본 문의하기 페이지 1:1 문의 접수 폼을 통해 이메일 주소와 결제 연락처를 적어 제출해 주시면 24시간 내에 결과를 즉시 복구해 드리거나 수동 복원을 진행해 드립니다."
    },
    {
      question: "비회원 결제인데 보고서 확인 링크(URL)를 잃어버렸습니다.",
      answer: "비회원 유저이시더라도 결제 4단계에서 직접 설정하셨던 '전화번호'와 '비밀번호 4자리'만 있으면 언제든 다시 열람하실 수 있습니다. 우측 상단의 비회원 주문 조회 페이지로 가셔서 로그인하시면 이전 해몽 내역을 안전하게 모아서 조회하실 수 있습니다."
    },
    {
      question: "결제 취소 또는 전액 환불은 어떻게 신청하나요?",
      answer: "구매 후 AI 연산(분석 처리중)이 시작되지 않은 횟수권 상태에서는 환불이 가능합니다. 단, 이미 AI 연산이 완료되어 텍스트 해몽 및 이미지가 완전히 추출된 리포트에 대해서는 디지털 콘텐츠 특성상 환불이 불가합니다. 세부 조항은 이용약관 제3조를 참고 바랍니다."
    }
  ];
